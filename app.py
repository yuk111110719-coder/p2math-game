...
if "question_bank" not in st.session_state:
    st.session_state.question_bank = [
        ...
        {"q": "星期三嘅後日係星期幾？（請輸入中文，如：星期X）", "a": "星期五", "difficulty": "中等"},
        {"q": "計算：9 x 8 - 12 = ?", "a": "60", "difficulty": "困難"},
        {"q": "停車場入面原本有15架車，走咗7架，之後又開入嚟9架，依家有幾多架車？", "a": "17", "difficulty": "困難"},
        {"q": "計算5 x 3 = ?", "a": "15", "difficulty": "簡單"},
        {"q": "計算8 + 9 = ?", "a": "17", "difficulty": "簡單"},
        {"q": "計算12 - 4 = ?", "a": "8", "difficulty": "簡單"},
        {"q": "計算100 + 200 = ?", "a": "300", "difficulty": "簡單"},
        ...
        {"q": "計算3 x 9 = ?", "a": "27", "difficulty": "簡單"},
        {"q": "把24枝鉛筆平均分給3個人，每人得幾枝？", "a": "8", "difficulty": "簡單"},
        {"q": "計算15 + 15 = ?", "a": "30", "difficulty": "簡單"},
        {"q": "計算40 - 18 = ?", "a": "22", "difficulty": "簡單"},
        {"q": "計算8 x 8 = ?", "a": "64", "difficulty": "簡單"},
        {"q": "時鐘上的短針代表什麼？（請輸入中文，如：X針）", "a": "時針", "difficulty": "中等"},
        {"q": "計算9 x 0 = ?", "a": "0", "difficulty": "簡單"},
        {"q": "計算50 + 50 = ?", "a": "100", "difficulty": "簡單"},
        {"q": "一打雞蛋有幾隻？", "a": "12", "difficulty": "簡單"},
        {"q": "計算2 x 6 = ?", "a": "12", "difficulty": "簡單"},
        {"q": "計算12 x 1 = ?", "a": "12", "difficulty": "簡單"},
        {"q": "豆豆原本有11粒朱古力，分左俾爸爸2粒，分左俾媽媽2粒，分左俾姐姐2粒，她仲有幾多粒?", "a": "5粒", "difficulty": "簡單"},
        {"q": "星期二嘅前一日係星期幾？（請輸入中文，星期X）", "a": "星期一", "difficulty": "中等"},
        {"q": "計算：4 x 5 + 10 = ?", "a": "30", "difficulty": "中等"},
        ...
        {"q": "計算：8 x 3 - 5 = ?", "a": "19", "difficulty": "中等"},
        ...
        {"q": "計算：7 x 4 = ?", "a": "28", "difficulty": "中等"},
        {"q": "爸爸有50元，買了兩本各12元的書，餘下多少元？", "a": "26", "difficulty": "中等"},
        {"q": "如果今天是星期一，3天後是星期幾？", "a": "星期四", "difficulty": "中等"},
        {"q": "計算：56 ÷ 8 = ?", "a": "7", "difficulty": "中等"},
        {"q": "4個5相加的結果是多少？", "a": "20", "difficulty": "中等"},
        {"q": "什麼圖形的角比直角小？", "a": "銳角", "difficulty": "困難"},
        {"q": "計算：9 x 8 + 18 = ?", "a": "90", "difficulty": "困難"},
        ...
        {"q": "計算：190 + 429 - 250 = ?", "a": "369", "difficulty": "困難"},
        {"q": "如果今天是4月28日，今日開始一連五天假期，假期的最後一天是幾月幾日？", "a": "5月2日", "difficulty": "困難"},
        {"q": "以下那一個是奇數，用2、8、12、5組成？", "a": "5", "difficulty": "困難"},
        {"q": "計算：189 - 210 + 444 = ?", "a": "423", "difficulty": "困難"},
        {"q": "有60粒珠，每8粒串成一條手鏈，可串成多少條？餘下幾粒？(請輸入中文，X條餘X粒)", "a": "7條餘4粒", "difficulty": "困難"},
        {"q": "蛋糕店有345個蛋糕，賣出120個，又賣出102個，還餘多少個？", "a": "123", "difficulty": "困難"},
        {"q": "哥哥由9:05看電影，看到11:15，這場電影長多少小時多少分鐘？(請輸入中文，X小時X分鐘)", "a": "2小時10分鐘", "difficulty": "困難"},
        {"q": "計算：230 - 125 - 50 = ?", "a": "55", "difficulty": "困難"},
        {"q": "媽媽買了8件壽司每件5元，又買了5串蝦串每串6元，共付多少元？", "a": "70", "difficulty": "困難"},
        {"q": "子傑有38張大相片，每頁相簿貼6張，需要多少頁相簿？", "a": "7", "difficulty": "困難"},
        {"q": "如果一個數除以7等於12，這個數是多少？", "a": "84", "difficulty": "困難"},
        {"q": "爸爸在上午9時上班，工作7小時30分後下班，下班時間是幾時幾分？(請輸入中文，下午X時X分)", "a": "下午4時30分", "difficulty": "困難"},
        {"q": "計算：56 ÷ 7 x 4 = ?", "a": "32", "difficulty": "困難"},
        {"q": "我有120元，弟弟有80元，合資買一個150元的蛋糕，餘下多少元？", "a": "50", "difficulty": "困難"},
        {"q": "一個四角錐體有多少個面？", "a": "5", "difficulty": "困難"},
        {"q": "計算：(15 + 22) x 2 = ?", "a": "74", "difficulty": "困難"},
        {"q": "樂樂有40元，每天坐巴士來回學校，每程6元，最多可坐多少天？", "a": "3", "difficulty": "困難"},
        {"q": "時鐘顯示的時間比現在慢了10分鐘，如果現在是12:08，鐘面顯示什麼時間？(請輸入XX:XX作答)", "a": "11:58", "difficulty": "困難"},
        {"q": "計算：88 + 12 = 100，那麼 100 - 88 = ?", "a": "12", "difficulty": "中等"},
        {"q": "一個三位數，百位是6，十位是2，個位是7，讀作什麼？(請輸入中文字作答)", "a": "六百二十七", "difficulty": "困難"},
        {"q": "計算：4 x 4 x 4 = ?", "a": "64", "difficulty": "困難"},
        {"q": "Sam哥哥有100元，每本練習簿20元，最多可買多少本？", "a": "5", "difficulty": "簡單"},
        {"q": "計算：(110 + 89 + 102) ÷ 3 = ?", "a": "101", "difficulty": "困難"},
