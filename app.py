...
if "p1_question_bank" not in st.session_state:
    ...
    {"q": "樹上有5隻小鳥，飛走了2隻，餘下多少隻小鳥？", "a": "3", "difficulty": "簡單", "options": ["2", "3", "4", "5"]},
    ...
    {"q": "小朱有6粒糖，吃了4粒，餘下多少粒？", "a": "2", "difficulty": "簡單", "options": ["1", "2", "3", "4"]},
    ...
    {"q": "熊爸爸今年30歲，熊仔今年5歲，熊爸爸比熊仔大多少歲？", "a": "25", "difficulty": "困難", "options": ["20", "25", "30", "35"]},
    ...
    {"q": "小魚、小鳥和小狗分別回家。請問，小魚居住在哪裡？？", "a": "水裡", "difficulty": "簡單", "options": ["水裡", "鳥巢", "草原", "樹上"]},
    {"q": "牙刷和下面哪一樣東西最有關係？", "a": "牙膏", "difficulty": "簡單", "options": ["牙膏", "帽子", "筷子"]},
    ...
    {"q": "魚蛋、燒賣、蛋撻、魚蛋、燒賣、蛋撻、魚蛋，下一個是什麼？", "a": "燒賣", "difficulty": "簡單", "options": ["魚蛋", "燒賣", "熱狗", "蛋撻"]},
    ...
    {"q": "哪一個洗手順序比較合理？ ", "a": "B", "difficulty": "簡單", "options": ["擦乾手→抹肥皂→沖水", "把手弄濕→抹肥皂搓洗→沖水→擦乾", "抹肥皂→擦乾→把手弄濕"]},
    {"q": "「小馬先拿出積木，接著蓋了一座高塔，最後高塔倒下了。」小馬最初做了什麼？", "a": "拿出積木", "difficulty": "簡單", "options": ["拿出積木", "蓋高塔", "高塔倒下", "收拾積木"]},
    {"q": "小丸比小豆高，小豆比小多高。請問誰最高？", "a": "小丸", "difficulty": "簡單", "options": ["小丸", "小豆", "小多"]},
    {"q": "第一個盤子裡有六顆草莓，第二個盤子裡有四顆草莓。請問，哪一個盤子裡的草莓比較多？", "a": "第一盤", "difficulty": "簡單", "options": ["第一盤", "第二盤", "一樣多"]},
    ...
    {"q": "把冰塊放在太陽下，一段時間後可能會變成甚麼？", "a": "水", "difficulty": "簡單", "options": ["風", "樹木", "水"]},
    {"q": "蝴蝶、獅子、長頸鹿、猴子，哪一個和其他三個不一樣？", "a": "蝴蝶", "difficulty": "簡單", "options": ["獅子", "猴子", "蝴蝶", "長頸鹿"]},
    {"q": "小猴、大熊、小豬分別拿蘋果、香蕉、葡萄。小猴拿香蕉，小豬拿蘋果，大熊沒有拿蘋果，也沒有拿香蕉。請問大熊拿的是甚麼？", "a": "葡萄", "difficulty": "困難", "options": ["蘋果", "香蕉", "葡萄", "橙子"]}
]
...
if not st.session_state.game_started:
    ...
    st.title("🧮 動動腦大冒險")
    st.write("小朋友你好！歡迎來到森林訓練營，請在下方選擇年級與設定選項後開始挑戰啦！")
